            ...
            <div class="row justify-content-between">
                <div class="card">
                    <div class="card-body">
                        ...
                        @php
                            $kategori_all = json_decode($tes);
                        @endphp
                        <button class="btn btn-secondary mt-5" data-bs-toggle="modal" data-bs-target="#modalResult">Show
                            All
                            Result</button>
                        <a href="https://www.pom.go.id/new/" class="btn btn-success mt-5" target="_blank">BPOM</a>
                        ...
                        <div class="modal fade" id="modalResult" tabindex="-1"
                            aria-labelledby="modalTambahPertanyaan" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        @for ($i = 0; $i < count($all_result); $i++)
                                            <p>{{ $i + 1 . '. ' . $all_result[$i] . ' - ' . $kategori_all[$i]->kategori }}
                                            </p>
                                        @endfor

...
Route::middleware(['auth','user-access:USER'])->group(function(){
    ...
    Route::prefix('user')->group(function(){
        Route::get('/history',[SurveiController::class,'history'])->name('history-user');
        Route::resource('/message',App\Http\Controllers\User\MessageController::class);
        Route::get('/message/details/{id}',[App\Http\Controllers\User\MessageController::class,'details'])->name('user.message-details');
    });
